...
if(PC_LIBTORRENT_RASTERBAR_FOUND)
    foreach(item ${PC_LIBTORRENT_RASTERBAR_CFLAGS})
        if("${item}" MATCHES "-D.*")
            list(APPEND LibtorrentRasterbar_DEFINITIONS ${item})
        endif()
    endforeach()
else()
    if(LibtorrentRasterbar_CUSTOM_DEFINITIONS)
        ...
        message(WARNING
            "Could not find pkg-config to get defines from libtorrent. "
            "A default set will be used. If it is wrong, the application may crash.")
